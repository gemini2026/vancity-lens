...
@pytest.mark.skip(reason="ResponsiveLayout component was refactored into app/layout.tsx and BottomTabBar.tsx")
...
@pytest.mark.skip(reason="App now uses CSS variables/theme system, not hardcoded dark classes")
class TestDarkTheme:
...
@pytest.mark.skip(reason="MobileNav and ResponsiveLayout were refactored away")
class TestIntegration:
    def test_all_components_present(self):
        components = [
            "BottomTabBar.tsx",  # This one actually exists
        ]
