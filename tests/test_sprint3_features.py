...
class TestEntitlementIntegration:
    ...
    async def test_bill44_included_in_response(self):
        ...
        conn.fetchrow.side_effect = [parcel, None, None, bill44_eligible, transit_distance]
    ...
    async def test_community_plan_included_when_applicable(self):
        ...
        conn.fetchrow.side_effect = [parcel, None, None, None]  # parcel + view cone + setback + bill44
